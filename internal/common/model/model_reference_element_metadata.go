...
// ReferenceElementMetadata type of ReferenceElementMetadata
type ReferenceElementMetadata struct {
...
// AssertReferenceElementMetadataConstraints checks if the values respects the defined constraints
func AssertReferenceElementMetadataConstraints(obj ReferenceElementMetadata) error {
	for _, el := range obj.Extensions {
