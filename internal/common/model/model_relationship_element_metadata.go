...
// RelationshipElementMetadata Relationship element metadata
type RelationshipElementMetadata struct {
...
// AssertRelationshipElementMetadataConstraints checks if the values respects the defined constraints
func AssertRelationshipElementMetadataConstraints(obj RelationshipElementMetadata) error {
	for _, el := range obj.Extensions {
