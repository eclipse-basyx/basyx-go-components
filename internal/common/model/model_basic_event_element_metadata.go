...
// BasicEventElementMetadata type of EventElement
type BasicEventElementMetadata struct {
...
// AssertBasicEventElementMetadataConstraints checks if the values respects the defined constraints
func AssertBasicEventElementMetadataConstraints(obj BasicEventElementMetadata) error {
	for _, el := range obj.Extensions {
