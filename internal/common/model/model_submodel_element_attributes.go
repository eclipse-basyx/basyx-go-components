...
// SubmodelElementAttributes type of SubmodelElement
type SubmodelElementAttributes struct {
...
// AssertSubmodelElementAttributesConstraints checks if the values respects the defined constraints
func AssertSubmodelElementAttributesConstraints(obj SubmodelElementAttributes) error {
	for _, el := range obj.Extensions {
