...
type AssetAdministrationShellRepositoryAPIAPIServicer interface {
	...
	PutThumbnailAasRepository(context.Context, string, string, io.ReadSeeker) (model.ImplResponse, error)
	...
	PutFileByPathAasRepository(context.Context, string, string, string, string, io.ReadSeeker) (model.ImplResponse, error)
