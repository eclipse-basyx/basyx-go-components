...
func (c *RegistryOfInfrastructuresAPIAPIController) GetAllInfrastructureDescriptors(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Printf("📍 [%s] Error in GetAllInfrastructureDescriptors: parse query raw=%q: %v", componentName, r.URL.RawQuery, err)
	...
	if query.Has("limit") {
		...
		if err != nil {
			log.Printf("📍 [%s] Error in GetAllInfrastructureDescriptors: parse limit=%q: %v", componentName, query.Get("limit"), err)
			result := common.NewErrorResponse(
				err,
				http.StatusBadRequest,
				componentName,
	...
	result, err := c.service.GetAllInfrastructureDescriptors(r.Context(), limitParam, cursorParam, nameParam, assetIdParam)
	if err != nil {
		log.Printf("📍 [%s] Error in GetAllInfrastructureDescriptors: service failure (limit=%d cursor=%q name=%q assetId=%q): %v", componentName, limitParam, cursorParam, nameParam, assetIdParam, err)
...
func (c *RegistryOfInfrastructuresAPIAPIController) PostInfrastructureDescriptor(w http.ResponseWriter, r *http.Request) {
	...
	if err := model.AssertInfrastructureDescriptorRequired(infrastructureDescriptorParam); err != nil {
		log.Printf("📍 [%s] Error in PostInfrastructureDescriptor: required validation failed: %v", componentName, err)
		result := common.NewErrorResponse(
			err,
			http.StatusBadRequest,
			componentName,
...
func (c *RegistryOfInfrastructuresAPIAPIController) GetInfrastructureDescriptorById(w http.ResponseWriter, r *http.Request) {
	...
	if infrastructureIdentifierParam == "" {
		log.Printf("📍 [%s] Error in GetInfrastructureDescriptorById: missing path parameter infrastructureIdentifier", componentName)
		result := common.NewErrorResponse(
	...
	if err != nil {
		log.Printf("📍 [%s] Error in GetInfrastructureDescriptorById: service failure (infrastructureIdentifier=%q): %v", componentName, infrastructureIdentifierParam, err)
		c.errorHandler(w, r, err, &result)
		return
	}
	_ = EncodeJSONResponse(result.Body, &result.Code, w)
...
func (c *RegistryOfInfrastructuresAPIAPIController) PutInfrastructureDescriptorById(w http.ResponseWriter, r *http.Request) {
	infrastructureIdentifierParam := chi.URLParam(r, "infrastructureIdentifier")
	if infrastructureIdentifierParam == "" {
		log.Printf("📍 [%s] Error in PutInfrastructureDescriptorById: missing path parameter infrastructureIdentifier", componentName)
		result := common.NewErrorResponse(
			common.NewErrBadRequest("Missing path parameter 'infrastructureIdentifier'"),
			http.StatusBadRequest,
			componentName,
	...
	if err := model.AssertInfrastructureDescriptorRequired(infrastructureDescriptorParam); err != nil {
		log.Printf("📍 [%s] Error in PutInfrastructureDescriptorById: required validation failed: %v", componentName, err)
		result := common.NewErrorResponse(
			err,
			http.StatusBadRequest,
			componentName,
	...
	if err := model.AssertInfrastructureDescriptorConstraints(infrastructureDescriptorParam); err != nil {
		log.Printf("📍 [%s] Error in PutInfrastructureDescriptorById: constraints validation failed: %v", componentName, err)
		result := common.NewErrorResponse(
			err,
			http.StatusBadRequest,
			componentName,
...
func (c *RegistryOfInfrastructuresAPIAPIController) DeleteInfrastructureDescriptorById(w http.ResponseWriter, r *http.Request) {
	infrastructureIdentifierParam := chi.URLParam(r, "infrastructureIdentifier")
	if infrastructureIdentifierParam == "" {
		log.Printf("📍 [%s] Error in DeleteInfrastructureDescriptorById: missing path parameter infrastructureIdentifier", componentName)
		result := common.NewErrorResponse(
			common.NewErrBadRequest("Missing path parameter 'infrastructureIdentifier'"),
			http.StatusBadRequest,
			componentName,
	...
	if err != nil {
		log.Printf("📍 [%s] Error in DeleteInfrastructureDescriptorById: service failure (infrastructureIdentifier=%q): %v", componentName, infrastructureIdentifierParam, err)
		c.errorHandler(w, r, err, &result)
		return
	}
	_ = EncodeJSONResponse(result.Body, &result.Code, w)
