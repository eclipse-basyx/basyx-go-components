...
# Wait for the registry of registries to be healthy
echo "Waiting for Registry of Registries to be ready..."
max_attempts=30
attempt=0

while [ $attempt -lt $max_attempts ]; do
    if curl -s -f http://localhost:5080/health > /dev/null 2>&1; then
        echo "Registry of Registries is healthy!"
        break
    fi
    attempt=$((attempt + 1))
...
if [ $attempt -eq $max_attempts ]; then
    echo "Error: Registry of Registries did not become healthy in time"
    exit 1
fi
...
echo "Pre-filling Registry of Registries with sample data..."

# Add AAS Registry descriptor
...
--data '{
    ...
    "id": "https://iese.fraunhofer.de/ror/d4e-tenant-0-aas-registry",
...
--data '{
    ...
    "id": "https://iese.fraunhofer.de/ror/d4e-tenant-0-aas-discovery",
    "company": "Fraunhofer IESE"
}'
...
--data '{
    ...
    "id": "https://iese.fraunhofer.de/ror/d4e-tenant-0-submodel-registry",
    "company": "Fraunhofer IESE"
}'
...
--data '{
    ...
    "id": "https://iese.fraunhofer.de/ror/d4e-tenant-0-aas-env-shells",
    "company": "Fraunhofer IESE"
}'
...
--data '{
    ...
    "id": "https://iese.fraunhofer.de/ror/d4e-tenant-0-aas-env-submodels",
    "company": "Fraunhofer IESE"
}'
...
--data '{
    ...
    "id": "https://iese.fraunhofer.de/ror/d4e-tenant-0-aas-env-concept-descriptions",
    "company": "Fraunhofer IESE"
}'

echo ""
echo "All sample data has been successfully added to Registry of Registries!"
