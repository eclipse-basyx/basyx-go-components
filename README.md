...
For operator-facing setup guidance, see the [BaSyx wiki](https://wiki.basyx.org) and the local [database schema documentation](docu/basyx-database-wiki/README.md). For developer-facing details, see the [developer structure overview](docu/developer/structure_overview.md).
